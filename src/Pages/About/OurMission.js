      ...
      <LineBox sx={{ alignItems: "center" }}>
        <RowBox>
          ...
          >
            ...
            <br /><br />
            Additionally, we believe accessibility and equal pay are necessary to make sure that the music industry is able to bloom. The point is not to change the way we experience the music scene, but to make sure it is fair and stabilised.
          </Typography>
        </RowBox>
      </LineBox>
    </>
